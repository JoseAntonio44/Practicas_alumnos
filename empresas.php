...
<body>
  ...
  if (isset($_POST['editar']) && !isset($_POST['cancelar'])) {
    ...
    $persona_contacto = $_POST['persona_contacto'];
  ?>
    <div id='contenedorInsercionEdicion'>
  ...
  if (isset($_POST['añadir_fct'])) {
    $nombre = $_POST['nombre'];
  ?>
    <div id='contenedorAñadirPractica'>
      <h1>AÑADIR NUEVA PRACTICA A LA EMPRESA: <?php echo $nombre; ?></h1>
      <!-- Formulario de inserción en la tabla practicas-->
      <form method='post' action='empresas.php' id='añadirPractica'>
